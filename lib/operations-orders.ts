    ...
    if (localOperationsDemoEnabled()) {
      ...
      return {
        ...
        orders: [
          ...
          demo({ id: "10000000-0000-0000-0000-000000000002", orderNumber: "AP-1047", customerName: "Marcus Rolle", total: 184.5, shippingAmount: 10, deliveryDetails: { address: { line1: "Business delivery address", country: "—" } }, createdAt: new Date(now - 42 * 60_000).toISOString() }),

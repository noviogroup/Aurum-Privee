...
function ResponsiveFillImage({ src, mobileSrc, alt, sizes, className }: { src: string; mobileSrc: string; alt: string; sizes: string; className: string }) {
  return (
      ...
      <section className="home-campaign-hero">
        ...
        <div className="home-campaign-visual">
          <picture className="home-campaign-picture">
            <source media="(max-width: 767px)" srcSet="/images/campaign/hero-popular-fragrances-v2-mobile.webp" />
            <Image
              src="/images/campaign/hero-popular-fragrances-v2.webp"
              alt="Dior Sauvage, Carolina Herrera Good Girl Blush, Baccarat Rouge 540 and Tom Ford Black Orchid fragrances"
              fill
              loading="eager"
              fetchPriority="high"
